...
timber.productPage = function (options) {
  ...
  if (variant) {
    ...
    $addToCart.addClass('disabled').prop('disabled', true);
    $addToCartText.html("Das Produkt ist zur Zeit leider vergriffen.");
    $quantityElements.hide();
  }
};
...
var ajaxifyShopify = (function(module, $) {
  ...
  adjustCart = function () {
    ...
    $('form#cart_form').submit(function(event) {
      $('input#accept:not(:checked)').each(function(){
        event.preventDefault();
        alert("Bitte bestätige die Allgemeinen Geschäftsbedingungen.");
      });
    });
